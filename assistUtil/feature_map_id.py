...
if __name__ == '__main__':
    ...
    a_feature_address = base_address + 'Flow_Feature\\mall.360.com_20151231_31\\flow_feature'
    a_id_flow_address = base_address + 'Flow_Feature\\mall.360.com_20151231_31\\id_feature.json'
